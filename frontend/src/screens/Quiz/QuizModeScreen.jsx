...
const QuizModeScreen = ({ onExit }) => {
    ...
    // Students see enrolled subjects; teachers see their own subjects
    ...
    const handleStartQuiz = async (subject) => {
        const displayTitle = subject.name;

        setIsLoading(true);

        try {
            const generatedData = await generateQuiz(subject.id);
            // Ensure title exists
    ...
    return <LectureSelection subjects={subjects} onSelect={handleStartQuiz} onExit={onExit} />;
};
        ...
        <div style={styles.pageContainer}>
            ...
            <div style={styles.contentWrapper}>
                <div style={styles.heroSection}>
                    ...
                    <p style={styles.subTitle}>Select a subject to begin your evaluation.</p>
                </div>
                ...
                <div style={styles.grid}>
                    ...
                    {subjects.length === 0 && (
                        <p style={{ color: 'var(--color-text-tertiary)' }}>
                            No subjects enrolled. Enroll in a subject first.
                        </p>
                    )}
                </div>
            </div>
                                    ...
                                    <div style={styles.optionsGrid}>
                                        {question.options.map((opt, idx) => (
                                            <button
                                                ...
                                                style={{
                                                    ...styles.optionBtn,
                                                    borderColor: answers[question.id] === idx ? '#24386c' : 'var(--color-border)',
                                                    backgroundColor: answers[question.id] === idx ? 'rgba(36,56,108,0.08)' : 'transparent',
                                                    color: answers[question.id] === idx ? '#24386c' : 'var(--color-text-secondary)'
                                                }}
...
const styles = {
    ...
    iconBox: {
        ...
        alignItems: 'center',
        justifyContent: 'center',
        border: '1px solid rgba(36,56,108,0.12)',
        color: '#24386c'
    },
    ...
    submitBtn: {
        ...
        cursor: 'pointer',
        boxShadow: '#24386c 0px 0px 0px 0px, #24386c 0px 0px 0px 1px',
    ...
    secondaryBtn: {
        ...
        justifyContent: 'center',
        marginRight: '0.75rem',
        boxShadow: 'var(--color-bg-surface) 0px 0px 0px 0px, var(--color-border) 0px 0px 0px 1px',
    },
